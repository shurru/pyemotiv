...
def plotSomething():
    if epoc.newRecord == False or epoc.plot_check == False or epoc.stop==True:
        return
...
def main():
    ...
    win_plot =anxgui.QtGui.QMainWindow()
    uiplot = anxgui.Ui_Form()
    ...
    uiplot.qwtPlot_4.setAxisScale(uiplot.qwtPlot_4.xBottom, 0, 512)
    uiplot.qwtPlot_4.setAxisScale(uiplot.qwtPlot_4.yLeft, 0, 6000)
